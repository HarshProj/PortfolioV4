      ...
      <div className="nav">
        ...
        <div className="navd">
          ...
          <div className="mode" onClick={props.handleclick}>
            ...
            <div className="comp"><Link to='#about' className='navigate' style={{ textDecoration: 'none' }}>About</Link></div>
            <div className="comp b12"><Link to='#skills' className='navigate' style={{ textDecoration: 'none' }}>Skills</Link>/<Link to='#work' style={{ textDecoration: 'none' }} className='navigate'>Projects</Link></div>
          </div>
